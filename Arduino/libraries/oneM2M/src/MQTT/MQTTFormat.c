		...
		unsigned short packetid, MQTTString topicName, unsigned char* payload, int payloadlen)
{
	...
	//DEBUG("MQTTStringFormat_publish topic lenstring = %s\n", (topicName.lenstring.data == NULL)?"NULL":topicName.lenstring.data);
	//DEBUG("MQTTStringFormat_publish topic data = %s\n", (topicName.cstring == NULL)?"NULL":topicName.cstring);
	//DEBUG("MQTTStringFormat_publish payload = %s\n", (payload==NULL)?"NULL":payload);
