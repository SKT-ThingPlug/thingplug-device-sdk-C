#ifndef RENESASTLS_CONFIG_H
#define RENESASTLS_CONFIG_H
...
//#define MBEDTLS_GCM_C    //AES in GCM mode�̡�base on parallel design�̡�therefore it can good performance on speed,cost and less delay
...
#else
#define MBEDTLS_SSL_MAX_CONTENT_LEN    8192 //2048
#endif
